...
<h1 style={{"margin-top":"75px","font-family":"cursive",marginBottom:"15px",textAlign:"center"}}>Today's Special</h1>
<div className="container" style={{display:"flex",justifyContent:"center"}}>
   ...
   {specialItems.map((item,key)=>{
     return(
      ...
      <p><i class="fa fa-star" style={{marginTop:"1px",marginRight:"5px",color:"orange"}}  aria-hidden="true"></i>4.2 
       <button onClick={()=>{
       navigate("/login")
      }} 
